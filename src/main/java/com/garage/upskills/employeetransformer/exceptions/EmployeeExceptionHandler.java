package com.garage.upskills.employeetransformer.exceptions;
...
public class EmployeeExceptionHandler {
    ...
    @ExceptionHandler(value = {SQLException.class, CouchDbException.class})
    public ResponseEntity<Object> handleDatabaseException(Exception exception) {
